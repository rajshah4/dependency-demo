...
- Demo handoff artifacts live in `docs/demo-runbook.md`, `docs/demo-repo-blueprints.md`, `docs/demo-bootstrap-commands.md`, `docs/demo-script.md`, `docs/cloud-demo-prompts.md`, `docs/demo-operator-log.md`, `docs/public-demo-results.md`, `docs/technical-reference.md`, `examples/demo-template-config.json`, and `examples/rajshah4-public-demo-config.json`.
